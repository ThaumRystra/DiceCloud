...
let ParserRules = [
    ...
    {"name": "rollExpression", "symbols": ["rollExpression", "_", (lexer.has("diceOperator") ? {type: "diceOperator"} : diceOperator), "_", "exponentExpression"], "postprocess": d => roll.create({left: d[0], right: d[4]})},
    {"name": "rollExpression", "symbols": ["singleRollExpression"], "postprocess": id},
    {"name": "singleRollExpression", "symbols": [{"literal":"d"}, "_", "singleRollExpression"], "postprocess": d => roll.create({left: constant.create({value: 1}), right: d[2]})},
    ...
    {"name": "unaryExpression", "symbols": [(lexer.has("additiveOperator") ? {type: "additiveOperator"} : additiveOperator), "_", "unaryExpression"], "postprocess": d => unaryOperator.create({operator: d[0].value, right: d[2]})},
    {"name": "unaryExpression", "symbols": ["notExpression"], "postprocess": id},
    {"name": "notExpression", "symbols": [(lexer.has("notOperator") ? {type: "notOperator"} : notOperator), "_", "notExpression"], "postprocess": d => not.create({right: d[2]})},
    ...
    {"name": "indexExpression", "symbols": ["indexExpression", {"literal":"["}, "_", "expression", "_", {"literal":"]"}], "postprocess": d => index.create({array: d[0], index: d[3]})},
    ...
    {"name": "arrayExpression", "symbols": [{"literal":"["}, "_", {"literal":"]"}], "postprocess": d => array.create({ values: [] })},
    {"name": "arrayExpression", "symbols": ["parenthesizedExpression"], "postprocess": id},
    {"name": "parenthesizedExpression", "symbols": [{"literal":"("}, "_", "expression", "_", {"literal":")"}], "postprocess": d => parenthesis.create({content: d[2]})},
    ...
    {"name": "number", "symbols": [(lexer.has("number") ? {type: "number"} : number)], "postprocess": d => constant.create({value: +d[0].value})},
    {"name": "name", "symbols": [(lexer.has("name") ? {type: "name"} : name)], "postprocess": d => accessor.create({name: d[0].value})},
    {"name": "string", "symbols": [(lexer.has("string") ? {type: "string"} : string)], "postprocess": d => constant.create({value: d[0].value})},
    {"name": "boolean", "symbols": [{"literal":"true"}], "postprocess": d => constant.create({value: true})},
    {"name": "boolean", "symbols": [{"literal":"false"}], "postprocess": d => constant.create({value: false})},
    {"name": "_", "symbols": []},
